...
I18n.defaultLocale = 'fr'; // If the current locale in device is not en or hi
I18n.locale = 'fr'; // If we do not want the framework to use the phone's locale by default
